  ...
  return (
    <>
      ...
      {tournaments.length === 0 ? (
        <div className="h-[40vh] flex flex-col items-center justify-center bg-zinc-900/20 border border-dashed border-white/5 rounded-[3rem] text-zinc-600 opacity-40">
          <Icons.Trophy className="w-16 h-16 mb-4" />
          <p className="font-mono text-sm tracking-[0.3em] uppercase italic">{"// NO_ACTIVE_ROOMS_FOUND"}</p>
          <p className="text-[10px] font-black mt-2 uppercase tracking-widest">New simulations will be deployed shortly.</p>
        </div>
      ) : (
